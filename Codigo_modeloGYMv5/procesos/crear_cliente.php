...
if (isset($_POST['submit'])) {
  $resultado = [
    'error' => false,
    'mensaje' => 'Se Registro el cliente ||  ' . escapar($_POST['pnombre']) . " ".escapar($_POST['papellido']).' || con éxito!!!' 
  ];
  ...
  try {
    ...
    $consultaSQL = "INSERT INTO cliente (idCliente,primerNombre,segundoNombre,primerApellido,segundoApellido, direccion,telefono,email)";
    ...
    <div class="col-md-12">
      ...
      <form method="post">
        ...
        <div class="form-group">
          ...
          <a class="btn btn-primary" href="listar_cliente.php"><strong>Listar Registros</strong></a>
