...
if (isset($_POST['submit'])) {
  $resultado = [
    'error' => false,
    'mensaje' => 'Se Registro el usuario ||  ' . escapar($_POST['pnombre']) . " ".escapar($_POST['papellido']).' || con éxito!!!' 
  ];
  ...
  try {
    ...
    $consultaSQL = "INSERT INTO persona (idPersona,primerNombre,segundoNombre,primerApellido,segundoApellido, direccion,telefono,email)";
...
<div class="container">
  <div class="row">
    <div class="col-md-12">
      <h2 class="mt-4">Registrar Clientes ModeloGYM</h2>
      <hr>
      <form method="post">
        ...
        <div class="form-group">
          ...
          <a class="btn btn-primary" href="listar_usuarios.php"><strong>Listar Registros</strong></a>
