...
if (isset($_POST['submit'])) {
  $resultado = [
    'error' => false,
    'mensaje' => 'Se Registro ' . escapar($_POST['pnombre']) . " ".escapar($_POST['papellido']).' con éxito!!!' 
  ];
...
<div class="container">
  <div class="row">
    <div class="col-md-12">
      <h2 class="mt-4">Registrar Usuario ModeloGYM</h2>
      <hr>
      <form method="post">
        ...
        <div class="form-group">
          ...
          <a class="btn btn-primary"  href="index.php"><strong>Inicio</strong></a>
        </div>
      </form>
    </div>
  </div>
